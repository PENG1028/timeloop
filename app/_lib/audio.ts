...
export class AudioEngine {
    ...
    async playBlobNow(blob: Blob): Promise<void> {
        ...
        try {
            ...
            await this._el.play();     // 需要先调用过 unlock（用户手势）才不会被拦截
        } finally {
